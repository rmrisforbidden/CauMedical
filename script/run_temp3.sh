...
# for TR_DATA_TYPE in 'seqAll_RF_4SplineNoise11Flex_num200_1Spline5Flex_num200' 'seqAll_RF_1Spline5Flex_num200_num250' #'seqAll_RF_005_003_001' # 'seqAll_RF_4SplineNoise11Flex_num200_1Spline5Flex_num200' 'seqAll_RF_1Spline5Flex_num200_num250'
# do
# for IS_EMB_LOSS in 1
# do
# for EPOCH in 26
...
# do
# for LAMB in 10 #10 100 #500 1000 1 10 5000 10000
# do
# for ENCODER in FC
# do
# CUDA_VISIBLE_DEVICES=$GPU python lightning_bolts/script/main_train_enc_with_our_RNN.py --default_root_dir $ROOT_DIR \
...
# for EPOCH in 100
# do
# for DECODER in simple_RNN #simple_FC
# do
# for LAMB in 1 10 #0.1
# do
# for ENCODER in RNN
# do
# CUDA_VISIBLE_DEVICES=$GPU python lightning_bolts/script/main_train_enc_with_our_RNN.py --default_root_dir $ROOT_DIR \
