...
for TR_DATA_TYPE in 'seqAll_RF_4SplineNoise11Flex_num200_num250' #'seqAll_RF_1Spline5Flex_num200_num250' 
do
for IS_EMB_LOSS in 1
do 
for EPOCH in 26
do
for DECODER in causal_RNN #simple_FC #none #causal_RNN
do
...
# for EPOCH in 26
# do
# for DECODER in simple_RNN #none #causal_RNN
# do
# for LAMB in 10 #10 0.1 #100 500 1000 1 10 5000 10000
# do
# for ENCODER in RNN
...
# for TR_DATA_TYPE in 'seqAll' #'seqAll_RF_1Spline5Flex_num200_num250' #'seqAll_RF_005_003_001' # 'seqAll_RF_4SplineNoise11Flex_num200_1Spline5Flex_num200' 'seqAll_RF_1Spline5Flex_num200_num250'
# do
# for IS_EMB_LOSS in 1
# do
# for EPOCH in 26
...
# do
# for LAMB in 10 1 50 #10 100 #500 1000 1 10 5000 10000
# do
# for ENCODER in FC #RNN #FC
# do
# CUDA_VISIBLE_DEVICES=$GPU python lightning_bolts/script/main_train_enc_with_our_RNN.py --default_root_dir $ROOT_DIR \
# --gpus 1 --seed $SEED --batch_size $BATCH --num_workers 4 \
# --max_epochs $EPOCH --decoder_type $DECODER --rec_lambda $LAMB \
...
# --max_epochs $EPOCH --decoder_type $DECODER --rec_lambda $LAMB \
# --is_emb_loss $IS_EMB_LOSS \
# --train_data_type $TR_DATA_TYPE --test_data_type $TE_DATA_TYPE --encoder_type $ENCODER
# done
# done
# done
# done
